...
export const HERO_CONTENT = {
  ...
  fa: {
    ...
    profileRole: "مهندس فول‌استک ارشد • منتور • مشاور",
    headline: "کمک به رشد سریع‌تر توسعه‌دهندگان\nو ساخت نرم‌افزار مقیاس‌پذیر برای استارتاپ‌ها.",
    subheadline:
      "به توسعه‌دهندگان تازه‌کار منتور می‌دهم، مقالات مهندسی عملی می‌نویسم\nو به تیم‌ها کمک می‌کنم با معماری تمیز سیستم‌های پایدار بسازند.",
